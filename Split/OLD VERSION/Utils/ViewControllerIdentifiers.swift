...
let QUESTION_SPLITTING_VIEW_CONTROLLER  = "questionSplittingViewController"
let YOUR_TOTAL_VIEW_CONTROLLER          = "yourTotalViewController"
let MENU_VIEW_CONTROLLER                = "menuViewController"
